...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView = inflater.inflate(R.layout.fragment_article_detail_coord, container, false);
        mCoordinatorLayout = (CoordinatorLayout)
                mRootView.findViewById(R.id.draw_coordinator_layout);
    ...
    public int getUpButtonFloor() {
        if (mCollapsingToolbarLayout == null || mPhotoView.getHeight() == 0) {
            return Integer.MAX_VALUE;
        }

        // account for parallax
        return mIsCard
                ? (int) mCollapsingToolbarLayout.getTranslationY() + mPhotoView.getHeight() - mScrollY
